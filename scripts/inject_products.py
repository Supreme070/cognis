...
<template id="cgp-band-tpl"><section class="cgp-band" aria-label="Products">
  <div class="cgp-inner">
    ...
    <div class="cgp-grid">
      ...
      <a class="cgp-card spog-card" href="https://spog.cognis.group" target="_blank" rel="noopener" style="--c:#5b54e0;--glow:rgba(91,84,224,.18)">
        <span class="cgp-line"></span>
        <p class="cgp-kick">Live &middot; Observability</p>
        <div class="spog-logo"><img src="/assets/products/spog-icon.svg" alt="" loading="lazy" decoding="async" width="32" height="32" /><span class="wm">SPOG</span></div>
        <p class="cgp-desc">The single pane of glass for enterprise operations. Federates IT, network, facilities, fleet, and security telemetry into one view — every number traced to its source.</p>
        <span class="cgp-go">Visit SPOG <span class="a">&rarr;</span></span>
      </a>
    </div>
  </div>
</section></template>
