...
SERVICES = {
    "ai-strategy-advisory": {
        ...
        "ben_lead": "An actionable roadmap, clear delivery requirements, internal capability transfer and governance built in from day one.",
        ...
        "cards": [
            ...
            ("Ready for Delivery", "Your roadmap defines the scope, owners, dependencies and success measures for implementation. Production engineering is a separate scope, which you can commission from Cognis or your chosen team."),
