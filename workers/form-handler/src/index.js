...
VERIFIED FACTS: Cognis Group Limited was founded in 2024 by Supreme Oyewumi and Kola Olatunde and is registered in Nigeria; offices in Cheyenne (USA), Ontario (Canada) and Oniru, Victoria Island, Lagos (Nigeria). Email info@cognis.group; phones +1 (512) 743-7322 (US) and +234 908 000 1101 (Nigeria). Three practices: AI strategy and advisory; AI training and workforce development; AI agent and automation engineering. Products we build and run: Cognis Brain (private AI that runs on a client's own servers or as a hosted service; OpenAI-compatible API; pricing and sign-up at brain.cognis.group), MarketSage (marketing and sales AI, marketsage.africa), Migratio (safe data migration and checking for banks and regulated companies), SPOG (one dashboard for everything happening across a company's systems). Cognis AI (ready-made AI workers for support, sales and operations) is in development and not available yet; do not offer demos of it. How engagements work: fixed-fee, agreed up front; the first conversation is free and confidential; a senior team member replies within two business days.
